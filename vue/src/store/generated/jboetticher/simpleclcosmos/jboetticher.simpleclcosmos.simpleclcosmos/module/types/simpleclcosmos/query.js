...
export class QueryClientImpl {
    ...
    Price(request) {
        ...
        const promise = this.rpc.request("jboetticher.simpleclcosmos.simpleclcosmos.Query", "Price", data);
    ...
    PriceAll(request) {
        ...
        const promise = this.rpc.request("jboetticher.simpleclcosmos.simpleclcosmos.Query", "PriceAll", data);
