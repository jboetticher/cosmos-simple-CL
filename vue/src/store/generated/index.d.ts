declare const _default: {
    ...
    JboetticherSimpleclcosmosJboetticherSimpleclcosmosClprice: (store: any) => void;
    JboetticherSimpleclcosmosJboetticherSimpleclcosmosSimpleclcosmos: (store: any) => void;
